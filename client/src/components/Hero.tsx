  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-20 left-10 text-6xl rotate-12 opacity-30">✏️</div>
        <div className="absolute top-40 right-20 text-5xl -rotate-12 opacity-30">📚</div>
        <div className="absolute bottom-40 left-20 text-5xl rotate-6 opacity-30">🎯</div>
        <div className="absolute bottom-20 right-10 text-6xl -rotate-6 opacity-30">🏆</div>
      </div>
      ...
      <div className="max-w-6xl mx-auto text-center space-y-8">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto rotate-playful-2">
          Discover motivated talent by teaching and evaluating DX-related skills through our gamified
          e-learning platform. Recruiters discover top performers. Learners earn recognition.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
          ...
          <Button variant="outline-brutal" size="lg" className="group">
          ...
          {[
            ...
            <div
              ...
              className={`bg-card brutal-border brutal-shadow rounded-xl p-6 hover:brutal-shadow-lg hover:-translate-y-1 transition-all ${
                i === 0 ? "rotate-playful-1" : i === 1 ? "rotate-playful-2" : "rotate-playful-3"
              }`}
            >
